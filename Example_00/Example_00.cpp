...
int main(void) {
	...
	printf("after building kernel\n");
	// Create the OpenCL kernel
	cl_kernel kernel = clCreateKernel(program, "vector_add", &ret);
	printf("ret at %d is %d\n", __LINE__, ret);

	printf("after building kernel2\n");
	// Create the OpenCL kernel
	cl_kernel kernel2 = clCreateKernel(program, "vector_mult", &ret);
	printf("ret at %d is %d\n", __LINE__, ret);
	...
	ret = clSetKernelArg(kernel2, 1, sizeof(cl_mem), (void *)&b_mem_obj);
	printf("ret at %d is %d\n", __LINE__, ret);

	ret = clSetKernelArg(kernel2, 2, sizeof(cl_mem), (void *)&c_mem_obj);
	printf("ret at %d is %d\n", __LINE__, ret);

	//added this to fix garbage output problem
	//ret = clSetKernelArg(kernel, 3, sizeof(int), &LIST_SIZE);

	printf("before execution kernel\n");
	...
	printf("before execution kernel2\n");
