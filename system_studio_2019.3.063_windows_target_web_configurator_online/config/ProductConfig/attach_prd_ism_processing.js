...
new function()
{
    ...
    // This script looking for ism component inside the attached products (by alias and version)
    ...
    this.Component = function(components, c_root, c_prod)
    {
        ns.Product = function(prod, root)
        {
            ...
            var ism = ComponentByAlias(prod, "ism");
            ...
            for(var i in childs)
            {
                ...
                if(id in ns_inst.Products)
                {
                    ...
                    {
                        if(ism)
                            detach_cmp_by_alias_and_version(pro, "ism", ism.Info().Property("ProductVersion"));
                    }
                }
            }
        }
