...
new function()
{
    ...
    this.Scenario = function(acts)
    {
        ...
        Log("Scenario::vs_integration: adding action into sequence");
        var scenario = this;
        var prod = scenario.Product();
       
        scenario.AddBefore(acts.Initialization, acts.GenerateVSIntegrationData, "skip-back");

        Log("Scenario::vs_integration: adding action into sequence done");
    }
}
